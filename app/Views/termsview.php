...
<div class="terms-container">
    ...
    <p>By accessing and using this website, you accept and agree to be bound by the terms and provision of this agreement. If you do not agree with any part of these terms, you must not use our website. </p>
    ...
    <p>The content, layout, design, data, databases, and graphics on this website are protected by intellectual property laws. You may not reproduce, distribute, or publish any content from this site without our explicit permission. </p>
    ...
    <h2>Limitations</h2>
    <p>In no event shall we or our suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on our website, even if we or an authorized representative has been notified orally or in writing of the possibility of such damage. Some jurisdictions do not allow limitations on implied warranties, or limitations of liability for consequential or incidental damages, these limitations may not apply to you. </p>
    ...
    <h2>Governing Law</h2>
    <p>Any claim relating to our website shall be governed by the laws of our home jurisdiction without regard to its conflict of law provisions. </p>
    ...
    <p>We may revise these terms of service for our website at any time without notice. By using this website you are agreeing to be bound by the then current version of these terms of service. Change is the only constant.</p>
    ...
    <h2>Contact Us</h2>
    <p>If you have any questions about these Terms, please contact us at your earliest convenience. We actually do want to hear from you.</p>
